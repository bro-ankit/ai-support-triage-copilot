...
import { RERANKER_DEFAULTS } from './kb-reranker.constants';
import type { RerankCandidate, RerankResult } from './kb-reranker.types';

@Injectable()
export class KbRerankerService implements OnModuleInit {
  private readonly modelId: string;
  private tokenizer!: PreTrainedTokenizer;
  private model!: PreTrainedModel;

  constructor(
    @InjectPinoLogger(KbRerankerService.name) private readonly logger: PinoLogger,
